                        ...
                        >
                            ...
                            <div className="px-6 py-5 space-y-5">
                                <div className="flex items-start gap-4">
                                    <div className="shrink-0 h-8 w-8 rounded-full bg-[#02090A] text-white flex items-center justify-center text-sm font-bold">1</div>
                                    <div className="flex-1 pt-1">
                                        <p className="text-sm text-[#02090A]">
                                            Toque no ícone{' '}
                                            <ArrowUpOnSquareIcon className="inline h-4 w-4 text-[#007AFF] -mt-0.5" />{' '}
                                            <span className="font-semibold">Compartilhar</span> na barra do navegador
                                        </p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-4">
                                    <div className="shrink-0 h-8 w-8 rounded-full bg-[#02090A] text-white flex items-center justify-center text-sm font-bold">2</div>
                                    <div className="flex-1 pt-1">
                                        <p className="text-sm text-[#02090A]">
                                ...
                                <div className="flex items-start gap-4">
                                    <div className="shrink-0 h-8 w-8 rounded-full bg-[#02090A] text-white flex items-center justify-center text-sm font-bold">3</div>
                                    <div className="flex-1 pt-1">
                                        <p className="text-sm text-[#02090A]">
